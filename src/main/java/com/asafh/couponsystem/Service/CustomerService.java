...
public class CustomerService extends ClientService {
	...
	public void purchaseCoupon(Coupon coupon) throws DeniedException, NotExistExeption {
		...
		if (coupon.getAmount() <= 0) {
			throw new NotExistExeption("you cant buy this coupon. it out of stock");
		}
	...
	private void addPurchase(Coupon coupon) {

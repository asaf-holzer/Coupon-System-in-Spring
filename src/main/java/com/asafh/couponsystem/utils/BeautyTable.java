...
//	public static void tableWithLinesCompaniesAllDetails(List<Company> companies) {
//		/*
//		 * leftJustifiedRows - If true, it will add "-" as a flag to format string to
//		 * make it left justified. Otherwise right justified.
//		 */
...
//		 */
//		//String ids=String.valueOf(id);
//		String[][] table = new String[companies.size()+1][5];// {{"id","name","email","password","coupons"}};
//		table[0][0]="id";
//		table[0][1]="name";
//		table[0][2]="email";
//		table[0][3]="password";
...
//			String idS=String.valueOf(compa.getId());
//			
//			String idSt=String.valueOf(((Coupon) compa.getCoupons()).getId());
//			String compID=String.valueOf(((Coupon) compa.getCoupons()).getCompanyID());
//			String categ= ( ((Coupon) compa.getCoupons()).getCategory()).toString();
//			String start=String.valueOf( ((Coupon) compa.getCoupons()).getStartDate());
//			String end=String.valueOf( ((Coupon) compa.getCoupons()).getEndDate());
//			String am=String.valueOf( ((Coupon) compa.getCoupons()).getAmount());
//			String pri= String.valueOf( ((Coupon) compa.getCoupons()).getPrice());
//			table[count][0]=idS;
//			table[count][1]=compa.getName();
//			table[count][2]=compa.getEmail();
//			table[count][3]=compa.getPassword();
//			table[count][4]=idSt+" "+compID+" "+categ+" "+start+" "+end+" "+am+" "+pri;
//			count++;
//		}
//		
//		/*
